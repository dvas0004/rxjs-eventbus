...
jsPlumb.ready(function () {
    ...
    if (!window.jsplumb_demo.eventbus){
        window.jsplumb_demo.eventbus = new rxjs.Subject();
    }

    const eventbus = window.jsplumb_demo.eventbus;
    ...
    eventbus.subscribe(
        (x) => {
            ...
            newNode.className ="window";
            newNode.id = String(Date.now());
            newNode.innerText ='Created From React!';
